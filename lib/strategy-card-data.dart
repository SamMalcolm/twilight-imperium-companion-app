List<Map> strategyCards = [
  ...
  },
  {
    ...
    "initiative": 2,
    "primary":
        "Choose one system other than the Mecatol Rex system that contains a planet you control; each other player places a command token from his reinforcements in the chosen system. Then, ready up to 2 exhausted planets you control.",
    "secondary":
  ...
  },
  {
    ...
    "initiative": 5,
    "primary":
        " • Gain 3 trade goods. \n • Replenish commodities. \n • Choose any number of other players. Thosee players use the secondary ability of this strategy card without spending a command token.",
    "secondary":
  ...
  },
  {
    ...
    "secondary":
        "Spend 1 token from your straategy pool to use the PRODUCTION ability of 1 of your space docks in your home system."
  },
  {
    "name": "Technology",
    "color": [25, 27, 117],
